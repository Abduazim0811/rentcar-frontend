...
export const user: User = { id: 7, name: 'Demo Customer', email: 'customer@example.com', role: 'customer' };
export const admin: User = { id: 1, name: 'Admin User', email: 'admin@example.com', role: 'admin' };
export const superAdmin: User = { id: 2, name: 'Super Admin', email: 'superadmin@rentcar.local', role: 'super_admin' };
