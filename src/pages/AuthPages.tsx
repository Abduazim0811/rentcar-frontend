...
function AuthForm({ mode }: { mode: 'login' | 'register' }) {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await register(String(f.get('name')), email, String(f.get('password')));
